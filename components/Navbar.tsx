...
const navigation = [
  ...
  { name: 'Cuartos', href: '/cuartos', current: false },
...
export default function Navbar() {
  ...
  return (<>{isClient && (
    <Disclosure suppressHydrationWarning={true} as="nav" className="bg-white">
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-gray-900 text-white' : 'text-black hover:bg-gray-200',
